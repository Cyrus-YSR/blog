...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#1d1c20] border border-white/[0.08] w-[40rem] rounded-[20px] shadow-2xl p-8 relative overflow-hidden",
        className
      )}>
      {children}
...
export const TextRevealCardDescription = ({
  ...
  return (<p className={twMerge("text-[#a9a9a9] text-2xl", className)}>{children}</p>);
};
